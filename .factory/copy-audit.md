...
Audited 2026-08-28 against `site/index.html`, including first-screen copy,
instructions, limits, pricing, and action feedback. Words split on spaces;
labels and fragments are included in the terminology check. No sentence is
longer than 22 words. No copy uses a banned marketing word.
...
- Job: **Scrub incident logs before sharing** — 5 words.
- User and change: the next sentence names engineers, bug escalation, and the
  values replaced — 14 words.
- First action: **Try it with sample data**. Its adjacent text says what opens
  and that nothing is saved.
- Facts: browser operation, offline reload, and price appear as three lines.

## Terminology

| Concept | One term used |
|---|---|
| Packaged support artifact | casefile |
| Redaction replacement | token |
| Browser try-out | demo |
| Example inputs | sample data |
| Optional purchase | team pack |
| User-defined detector set | policy |
